...
@section('description', "Yangilik - ". $news->title_uz)
...
@section('body')
        ...
        <div class="container">
            <nav>
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $news->title_uz }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container">
            <div>
                <h2 class="text-black fw-bold">{{ $news->title_uz }}</h2>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="gap-2">
                                ...
                                <div class="card border-0 shadow-sm overflow-hidden rounded-3">
                                    ...
                                    <div class="card-body">
                                        <div class="float-end gap-3 d-flex">
                                            <div class="gap-2">
                                                <a class="text-muted"
                                                   href="https://t.me/share/url?url=http://insoncj.eo/news/{{ $news->id }}&text={{$news->title_uz}}" target="_blank">
                            ...
                            <div class="mb-4">
                                <h5 class="mb-4 text-dark">{{ $news->title_uz }}</h5>
                                <p>
                                    {{ $news->text_uz }}
                                </p>
                            </div>
                                            ...
                                            @foreach($latest6 as $n)
                                                <div class="col-4">
                                                    <a href="{{ route('newsShow', $news->id) }}">
                                                        <img src="{{ asset('images/' . $n->image) }}" class="img-fluid h-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-8 d-flex flex-column">
                                                    <a href="{{ route('newsShow', $n->id) }}">
                                                        ...
                                                        <div class="card-body p-3">
                                                            <h3 class="card-title mb-1 h5 text-dark">{{ $n->title_uz }}</h3>
                                                        </div>
