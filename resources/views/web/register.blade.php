        ...
        <div class="container py-5 login">
            ...
            <div id="login">
                <div class="m-auto bg-white shadow-sm p-5 rounded-3 text-center col-md-4 mx-auto">
                    <h3 class="fw-bold text-black mb-2">Ro'yxatdan o'tish</h3>
                    <form action="{{ route('register') }}"  method="POST" class="text-start pt-4">
                        @csrf
                        <div class="mb-3">
                            <label for="fish" class="form-label small text-muted">F.I.SH <small class="text-danger">*</small></label>
                        ...
                        <button type="submit" class="btn btn-dark fw-bold fs-7 rounded-3 shadow-sm w-100 border-0 px-4 py-3 text-uppercase">Ro'yxatdan o'tish</button>
                    </form>

                    <p class="text-muted mb-0">Tizimda oldin ro'yxatdan o'tganmisiz? <a href="{{ route('login') }}" class="text-mdinfo">Kirish</a></p>
                </div>
