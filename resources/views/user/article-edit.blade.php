...
@section('content_name', "Maqolani tahrirlash")
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" id="article_form" action="{{ route('profile.article.update',$article->id) }}" class="card-body row" enctype="multipart/form-data">
                            @csrf
                            @method('put')

                            <div class="form-group col-md-12">
                                <label for="title">Maqola mavzusi</label>
                                <input type="text" name="title"  class="form-control" id="title" required placeholder="Maqola mavzusi" value="{{ $article->title }}">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="authors"  class="form-control" id="authors" required value="{{ $article->authors }}" placeholder="Muallif1, Muallif2, ...">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="abstract">Maqola annotatsiyasi</label>
                                <textarea id="abstract" class="form-control" name="abstract" rows="4" placeholder="Annotatsiya">{{ $article->abstract }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="keywords">Kalit so'zlar (* Kalit so'zlarni vergul bilan ajratilgan holda kiriting!)</label>
                                <input type="text" name="keywords"  class="form-control" id="keywords" required value="{{ $article->keywords }}" placeholder="Kalit so'zlar">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="file">Maqolani yuklash(* Maqola .doc va .docx formatida bo'lishi va hajmi 15mb dan oshmasligi kerak.) </label>
                                <input type="file" name="file"  class="form-control" id="file"  placeholder="file" accept=".doc , .docx">
                            </div>
